defmodule Remind.Account.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Remind.Repo)
  ...
  """
  def valid_password?(%Remind.Account.User{hashed_password: hashed_password}, password)
